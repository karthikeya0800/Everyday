...
# new_headline=$(echo "$headline" | sed 's/World/Universe/')
# echo "$new_headline"
...
#   --data-raw '{"profile":{"resumeHeadline":"'"$headline"'"},"profileId":"3a0bf38be7d564d4cfdaea70808e1911bec785d932e2c3ee113f03cb115cb3db"}'